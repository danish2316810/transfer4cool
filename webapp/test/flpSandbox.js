		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sales order",
									"targetURL": "#navigate2sales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigate2sales-display": {
								"semanticObject": "navigate2sales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigate2sales",
									"url": sap.ui.require.toUrl("navigate2sales")
								}
							}
						}
					}
